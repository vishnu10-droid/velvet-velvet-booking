...
const items = [
  {
    quote:
      "The most thoughtful stay I've experienced in years. Every detail, from turn-down service to the espresso bar, felt personal.",
    name: "Eleanor Vance",
    role: "Travel Editor, Veridian",
  },
  {
    quote:
      "Aurélia redefines what a city hotel can be — quiet, cinematic, and impossibly elegant. We'll be back every season.",
    name: "Marcus Holloway",
    role: "Architect",
  },
  {
    quote:
      "From the first hello in the lobby to a sunrise on the terrace, it felt like staying with old friends in extraordinary taste.",
    name: "Priya Nair",
